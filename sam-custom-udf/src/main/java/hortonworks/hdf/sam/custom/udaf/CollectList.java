package hortonworks.hdf.sam.custom.udaf;
...
public class CollectList implements UDAF<List<Object>, Object, List<Object>> {
    ...
    public List<Object> result(List<Object> aggregate) {
    	System.out.println("********** CountList returning list size: " + aggregate.size());
    	System.out.println("********** CountList returning list output: " + aggregate.toString());
    	return aggregate;
    }
}
